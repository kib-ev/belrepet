...
jQuery(document).ready(function() {
	...
	function feeRangeslider(){
		jQuery("#tg-feerangeslider").slider({
			...
			min: 0,
			max: 30,
			values: [ jQuery("#tg-feerangeslider").data('min'), jQuery("#tg-feerangeslider").data('max') ],
	...
	function activityRangeslider(){
		jQuery("#tg-activityrangeslider").slider({
			range: true,
			min: 0,
			max: 100,
			values: [ jQuery("#tg-activityrangeslider").data('min'), jQuery("#tg-activityrangeslider").data('max') ],
			slide: function( event, ui ) {
				jQuery( "#tg-activityrangeamount" ).val( ui.values[ 0 ] + " - " + ui.values[ 1 ] );
			}
		});
		jQuery( "#tg-activityrangeamount" ).val( jQuery( "#tg-activityrangeslider" ).slider( "values", 0 ) + " - " + jQuery( "#tg-activityrangeslider" ).slider( "values", 1 ) );
	}
	activityRangeslider();
	/* -------------------------------------
			Google Map
