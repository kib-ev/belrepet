/* global document */
//Init Map Scripts
function tutor_init_map_script(){
	var directory_path = '';
	var _data_list		 = data;
	...
	if( _data_list.status == 'found' ){
		...
		for (var i=0; i < response_data.length; i++) {
			...
			infobox_html += '<figure class="tg-dpbox"><img src="'+response_data[i].image+'" alt="'+response_data[i].title+'"></figure>';
			infobox_html += '<div class="tg-mapinfobox">';
				...
				infobox_html += '<ul class="tg-jobsmetadata"><li><span class="tg-stars"><span></span></span></li><li><a href="#"><i class="fa fa-heart tg-like"></i></a></li><li><a href="#">1509 view</a></li></ul>';
