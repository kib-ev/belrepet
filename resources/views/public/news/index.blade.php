...
<!--************************************
            Inner Banner Start
    *************************************-->
<div id="tg-innerbanner" class="tg-innerbanner tg-haslayout tg-parallaximg" data-appear-top-offset="600" data-parallax="scroll" data-image-src="{{ url('/images/parallax/bgparallax-07.jpg') }}">
    <div class="container">
        <div class="row">
                ...
                <div class="tg-blogpost tg-blogposgrid">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <article class="tg-post">
                            <figure class="tg-postimg"><a href="{{ $item->link() }}"><img src="{{ url($item->preview) }}" alt=""></a></figure>
